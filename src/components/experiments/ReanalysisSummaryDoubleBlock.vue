<template>
  <div class="w-full overflow-x-auto">
    <table class="w-full min-w-[1400px] border-collapse table-fixed text-[13px] text-[--text-main]">
      <colgroup>
        <col class="w-[10%]" />
        <col class="w-[10%]" />
        <col class="w-[10%]" />
      ...
      <tbody>
        <tr>
          <td class="sr-title" colspan="10">
            <div class="flex items-center justify-between gap-3">
              <div class="text-[26px] font-bold">样品重分析汇总表（双份复测）</div>
              <div class="text-[16px] font-medium">BA-SBR21 / 2V</div>
            </div>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="sr-head text-center" colspan="2">重分析处理双份结果(ng/mL)</td>
        ...
        <tr>
          <td class="sr-label" colspan="12" style="font-size:11px; font-weight:normal; background:#fffdf6;">
            注：1. 重分析理由和报告值理由参见SOP &nbsp; 2. 重分析理由和上报该浓度值理由若过长可用代号指代
          </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="sr-label" colspan="3">审核人 / 日期</td>
          <td class="sr-cell" colspan="9"><CellEditor :value="model.signatures.auditor" :editable="editable" @update="updateSignature('auditor', $event)" /></td>
        </tr>
      </tbody>
    </table>
