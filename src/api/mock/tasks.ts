...
export const tasks: Task[] = [
  {
    id: 'T001', planId: 'PLAN-BRH-BIO-2025-001-DRAFT', taskName: '系统适用性验证任务',
  ...
  {
    id: 'T002', planId: 'PLAN-BRH-BIO-2025-001-DRAFT', taskName: '准确度与精密度验证',
  ...
  {
    id: 'T003', planId: 'PLAN-BRH-BIO-2025-001-DRAFT', taskName: '选择性考察',
